                ...
                for ground_truth in ["LME_Ti_Spot","LME_Co_Spot","LME_Al_Spot","LME_Zi_Spot","LME_Le_Spot","LME_Ni_Spot"]:
                    for horizon in [1,3,5]:
                        ...
                        for s, split_date in enumerate(split_dates[:-1]):
                            ...
                            true_data_x_tr = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_X_tr_"+ground_truth+str(horizon)+"_l5_"+"v16_"+split_date[1])
                            true_data_y_tr = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_y_tr_"+ground_truth+str(horizon)+"_l5_"+"v16_"+split_date[1])
                            true_data_x_va = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_X_va_"+ground_truth+str(horizon)+"_l5_"+"v16_"+split_date[1])
                            true_data_y_va = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_y_va_"+ground_truth+str(horizon)+"_l5_"+"v16_"+split_date[1])
                            ...
                            assert ((y_va == true_data_y_va).all())                
        # read data configure file
    data_configure_file = 'exp/3d/Co/logistic_regression/v3/LMCADY_v3.conf'
    with open(os.path.join(sys.path[0],data_configure_file)) as fin:
        fname_columns = json.load(fin)
    if action == 'train':
        comparison = None
                ...
                for ground_truth in ["LME_Ti_Spot","LME_Co_Spot","LME_Al_Spot","LME_Zi_Spot","LME_Le_Spot","LME_Ni_Spot"]:
                    for horizon in [1,3,5]:
                        ...
                        for s, split_date in enumerate(split_dates[:-1]):
                            ...
                            true_data_x_tr = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_X_tr_"+ground_truth+str(horizon)+"_l"+str(lag)+"_"+version+"_"+split_date[1])
                            true_data_y_tr = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_y_tr_"+ground_truth+str(horizon)+"_l"+str(lag)+"_"+version+"_"+split_date[1])
                            true_data_x_va = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_X_va_"+ground_truth+str(horizon)+"_l"+str(lag)+"_"+version+"_"+split_date[1])
                            true_data_y_va = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_y_va_"+ground_truth+str(horizon)+"_l"+str(lag)+"_"+version+"_"+split_date[1])
...
def test_two():
    ...
    if action == 'train':
        ...
        for f in fname_columns:
            ...
            we check the different version
            """
            for version in ["v10","v12","v24","v28","v30"]:
                if version not in ["v10","v12"]:
                    lag = 1
                else:
                    lag = 5
                from utils.read_data import read_data_NExT
                ...
                for horizon in [1,3,5]:
                        for s, split_date in enumerate(split_dates[:-1]):
                            ...
                            we load the accurate feature from the file
                            """
                            true_data_x_tr = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_X_tr_"+"ALL"+str(horizon)+"_l"+str(lag)+"_"+version+"_"+split_date[1])
                            true_data_y_tr = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_y_tr_"+"ALL"+str(horizon)+"_l"+str(lag)+"_"+version+"_"+split_date[1])
                            true_data_x_va = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_X_va_"+"ALL"+str(horizon)+"_l"+str(lag)+"_"+version+"_"+split_date[1])
                            true_data_y_va = np.loadtxt(os.sys.path[0]+"/code/feature_pytest/lagged_data/lagged_data_y_va_"+"ALL"+str(horizon)+"_l"+str(lag)+"_"+version+"_"+split_date[1])
                            norm_volume = "v1"
                            norm_3m_spread = "v1"
                            norm_ex = "v1"
                            len_ma = 5
