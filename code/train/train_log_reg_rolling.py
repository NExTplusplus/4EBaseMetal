...
if __name__ == '__main__':
    ...
    with open(args.output,"w") as out:
        out.write("Train Start,Val Start,Test Start,C,Lag,Volume,Spread,Exchange,Validation,Training,Testing,\n")
            ...
            for f in fname_columns:
                ...
                for lag in [5,10,20,30]:
                    for norm_volume in ["v1","v2"]:
                        for norm_ex in ["v1"]:
                            for split_dates in [["2011-07-01","2016-07-01","2016-12-31"],["2011-01-01","2016-01-01","2016-07-01"],["2010-07-01","2015-07-01","2015-12-31"],["2010-01-01","2015-01-01","2015-07-01"],["2009-07-01","2014-07-01","2014-12-31"]]:
                                norm_3m_spread = "v1"
                                len_ma = 5
                                len_update = 30
                                tol = 1e-7
                                ...
                                for C in [0.00001,0.0001,0.001,0.01]:
                                    ...
                                    out.write(split_dates[0]+",")
                                    out.write(split_dates[1]+",")
                                    out.write(split_dates[2]+",")
                                    out.write(str(C)+",")
                                    out.write(str(lag)+",")
