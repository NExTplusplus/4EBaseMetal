            ...
            for split_date in split_dates:
                ...
                if len(result_v5_error)==0:
                    ...
                    for i in range(window_size,len(y_va)):
                        ...
                        weight_xgb_v5 = result_v5_previous_weight[length]*weight+(1-weight)*float(1/error_xgb_v5)/(1/error_xgb_v5+1/error_xgb_v7+1/error_xgb_v10+1/error_lr)
                        weight_xgb_v7 = result_v7_previous_weight[length]*weight+(1-weight)*float(1/error_xgb_v7)/(1/error_xgb_v5+1/error_xgb_v7+1/error_xgb_v10+1/error_lr)
                        weight_xgb_v10 = result_v10_previous_weight[length]*weight+(1-weight)*float(1/error_xgb_v10)/(1/error_xgb_v5+1/error_xgb_v7+1/error_xgb_v10+1/error_lr)
                        weight_lr = result_lr_previous_weight[length]*weight+(1-weight)*float(1/error_lr)/(1/error_xgb_v5+1/error_xgb_v7+1/error_xgb_v10+1/error_lr)
