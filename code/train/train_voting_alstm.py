  ...
  for ground_truth in ["LME_Co_Spot","LME_Al_Spot","LME_Ni_Spot","LME_Ti_Spot","LME_Zi_Spot","LME_Le_Spot"]:
      for window_size in [5,10,15,20,25,30]:
        for date in ["2014-07-01","2015-01-01","2015-07-01","2016-01-01","2016-07-01","2017-01-01","2017-07-01","2018-01-01","2018-07-01"]:
          ALSTM_v16 = np.loadtxt("data/ALSTM_label/"+ground_truth+str(horizon)+"_"+date+"_lr_v3_probability.txt")
          ALSTM_v26 = np.loadtxt("data/ALSTM_label/"+ground_truth+str(horizon)+"_"+date+"_lr_v5_probability.txt")
          ALSTM_v26 = np.loadtxt("data/ALSTM_label/"+ground_truth+str(horizon)+"_"+date+"_lr_v7_probability.txt")
