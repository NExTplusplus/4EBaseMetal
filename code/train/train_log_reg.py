...
if __name__ == '__main__':
    ...
    with open(args.output,"w") as out:
        out.write("Horizon,C,Lag,Volume,Spread,Exchange,Iterations,Validation,Testing,\n")
                        ...
                        for C in (0.01,0.1,1,10,100):
                            for norm_ex in ("v1","v2"):
                                for norm_volume in ("v1","v2","v3","v4"):
                                    ...
                                    parameters = {"penalty":"l2", "C":C, "solver":"lbfgs", "tol":tol,"max_iter":4*len(f)*max_iter, "verbose" : 5,"warm_start":False}
