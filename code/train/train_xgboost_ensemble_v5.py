            ...
            for split_date in split_dates:
                ...
                if len(result_v7_error)==0:
                    ...
                    for i in range(window_size,len(y_va)):
                        ...
                        weight_xgb_v7 = float(1/error_xgb_v7)/(1/error_xgb_v7+1/error_xgb_v10+1/error_lr)
                        weight_xgb_v10 = float(1/error_xgb_v10)/(1/error_xgb_v7+1/error_xgb_v10+1/error_lr)
                        weight_lr = float(1/error_lr)/(1/error_xgb_v7+1/error_xgb_v10+1/error_lr)
                        result=0
                        #v5_item=1
                        v7_item=1
                        v10_item=1
                        ...
                        length+=1
                    print("the weight ensebmle for V7 V10 LR voting precision is {}".format(metrics.accuracy_score(true_result, final_list)))
