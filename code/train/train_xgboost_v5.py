                                    ...
                                    for split_date in split_dates:
                                        ...
                                        for fold_n, (train_index, valid_index) in enumerate(folds.split(train_X)):
                                            ...
                                            if fold_n == 0:
                                                ...
                                                folder_1=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                                folder_1=folder_1.reshape(len(folder_1),1)
                                            elif fold_n == 1:
                                                #folder_2=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(i)+".txt")
                                                folder_2=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                                folder_2=folder_2.reshape(len(folder_2),1)
                                            elif fold_n==2:
                                                #folder_3=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(i)+".txt")
                                                folder_3 = np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                                folder_3=folder_3.reshape(len(folder_3),1)
                                            elif fold_n==3:
                                                #folder_4=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(i)+".txt")
                                                folder_4 = np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                                folder_4=folder_4.reshape(len(folder_4),1)
                                            elif fold_n==4:
                                                #folder_5=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(i)+".txt")
                                                folder_5=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                                folder_5=folder_5.reshape(len(folder_5),1)
                                            elif fold_n==5:
                                                #folder_6=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(i)+".txt")
                                                folder_6=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                                folder_6=folder_6.reshape(len(folder_6),1)
                                            elif fold_n==6:
                                                #folder_7=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(i)+".txt")
                                                folder_7=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                                folder_7=folder_7.reshape(len(folder_7),1)
                                            elif fold_n==7:
                                                #folder_8=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(i)+".txt")
                                                folder_8=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                                folder_8=folder_8.reshape(len(folder_8),1)
                                            elif fold_n==8:
                                                #folder_9=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(i)+".txt")
                                                folder_9=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                                ...
                                                folder_10=np.loadtxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_"+str(max_depth)+"_"+str(learning_rate)+"_"+str(gamma)+"_"+str(min_child_weight)+"_"+str(subsample)+".txt")
                                        ...
                                        print("the ground_truth is {}".format(args.ground_truth))
