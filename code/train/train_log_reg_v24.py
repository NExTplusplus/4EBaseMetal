# -*- coding: utf-8 -*-
"""
Created on Wed Nov  6 10:56:20 2019
    ...
    if args.action == 'train':
        ...
        for f in fname_columns:
            ...
            for s, split_date in enumerate(split_dates[:-1]):
                ...
                final_X_te = []
                final_y_te = [] 
                tech_params = {'strength':0.01,'both':3,'Win_VSD':[10,20,30,40,50,60],'Win_EMA':[12,26,40,65,125],'Win_Bollinger':[5,10,15,20,30,65],
            ...
            pd.DataFrame(ans).to_csv("_".join(["log_reg",args.ground_truth[0],args.version,str(args.lag),str(args.steps)+"_scale.csv"]))
