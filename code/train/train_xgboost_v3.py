        ...
        for f in fname_columns:
            ...
            for split_date in split_dates:
                ...
                for fold_n, (train_index, valid_index) in enumerate(folds.split(train_X)):
                    ...
                    X_train, X_valid = train_X[column_lag_list], train_X[column_lag_list].iloc[valid_index]
                    y_train, y_valid = train_y, train_y.iloc[valid_index]
                    ...
                    np.savetxt(str(lag)+"_"+str(split_date[1])+"_"+args.ground_truth[0]+"_"+str(fold_n)+"_hyperparameter_1"+".txt", prediction_each_folder)
