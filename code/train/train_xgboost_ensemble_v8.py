...
if __name__ == '__main__':
    ...
    parser.add_argument('-window_size','--window_size',type=int,help='there is the size fo the window size',default=10)
    parser.add_argument('-weight','--weight',type=int,help='the weight of the ',default=0.1)
                ...
                if len(result_v7_error)==0:
                    ...
                    for i in range(window_size,len(y_va)):
                        ...
                        if result>0.5:
                            ...
                            final_list.append(0)
                        length+=1
                    print("the weight ensebmle for V7 V10 LR rank rank precision is {}".format(metrics.accuracy_score(true_result, final_list)))
                    ...
                    for i in range(len(y_va)):
                        ...
                        if result>0.5:
                            ...
                            final_list.append(0)
                        length+=1
                    print("the weight ensebmle for V7 V10 LR rank rank precision is {}".format(metrics.accuracy_score(y_va, final_list)))
                    print("the horizon is {}".format(horizon))
                    print("the lag is {}".format(lag))
                    print("the train date is {}".format(split_date[0]))
                    print("the test date is {}".format(split_date[1]))