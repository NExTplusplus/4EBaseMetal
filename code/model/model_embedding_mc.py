...
class bilstm(nn.Module):
    def __init__(self,input_dim,hidden_dim,num_layers,lag,h,dropout,dropout_test,
                 case_number,embedding_size,alpha=0.01):
    ...
    def train_dropout(self):
        self.layer.dropout = self.dropout
        for att in self.selfattention:
            att.encoders._dropout_p = self.dropout

    def test_dropout(self):
        self.layer.dropout = self.dropout_test
        for att in self.selfattention:
            att.encoders._dropout_p = self.dropout_test