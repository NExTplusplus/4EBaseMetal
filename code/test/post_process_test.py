...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-m','--min', help='minimum coverage', type = float, default = 0.2
    )
    parser.add_argument(
    ...
    window = range(10,51,2)
    comb = product(window,limiting_factor)
    strat7 = post_process(copy(ts), split_dates, "strat7", strat_results, ground_truth, strategy_params,activation_params,comb,args.min)
