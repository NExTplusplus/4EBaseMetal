...
new_frame.sort_values(by='near_mean_result',ascending=False)[:5].to_csv(path.split(".")[0]+"_mean_near_voting.csv",index=False)
new_frame.sort_values(by='far_mean_result',ascending=False)[:5].to_csv(path.split(".")[0]+"_mean_far_voting.csv",index=False)
new_frame.sort_values(by='reverse_mean_result',ascending=False)[:5].to_csv(path.split(".")[0]+"_mean_reverse_voting.csv",index=False)
new_frame.sort_values(by='same_mean_result',ascending=False)[:5].to_csv(path.split(".")[0]+"_mean_same_voting.csv",index=False)
